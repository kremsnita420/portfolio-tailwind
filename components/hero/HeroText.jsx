export default function HeroText() {
	return (
		<div className='flex pl-5 md:px-5 flex-col items-start justify-start'>
			...
			<h2 className='text-1xl md:text-2xl xl:text-3xl mb-10 text-left animate-moveRight3'>
				<span className='p-2 border-t-2 border-l-2 border-b-2 border-gray-800 dark:border-gray-200'>
					and
				</span>
				<span className='p-2 border-t-2 border-l-2 border-b-2 border-gray-800 dark:border-gray-200'>
			...
			<button
				className='border-2 mt-10 w-auto px-10 font-heading1 
                           font-black  py-5 rounded-md animate-moveRight4
